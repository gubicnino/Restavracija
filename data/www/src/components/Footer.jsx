...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="relative bg-black-rich border-t border-white/5">
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="text-gray-400 font-inter text-sm font-light mb-6 leading-relaxed">
              Kjer se vonj žara prepleta z rečnim vetričem. Dve lokaciji ob Dravi, ena strast do
              mesa in pristne kulinarike.
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 border border-white/10 flex items-center justify-center text-gray-400 hover:text-gold hover:border-gold transition-colors duration-300"
          ...
          >
            ...
            <div className="space-y-6">
              {locations.map((location, index) => (
                <div key={index}>
                  <h5 className="text-gold font-inter text-sm font-medium mb-2">{location.name}</h5>
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        className="text-gray-400 font-inter text-xs font-light hover:text-gold transition-colors"
                      >
                        {location.phone}
                      </a>
                    </li>
            ...
            <ul className="space-y-3">
              {hours.map((item, index) => (
                <li key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-white font-inter text-sm block">{item.day}</span>
                    <span className="text-gray-400 font-inter text-sm font-light">{item.time}</span>
                  </div>
                </li>
              ))}
            </ul>
          ...
          >
            <h4 className="font-playfair text-lg text-white mb-6">Hitre Povezave</h4>
            <ul className="space-y-3">
            ...
            <div className="mt-8 pt-8 border-t border-white/5">
              <h5 className="text-white font-inter text-sm font-medium mb-3">Posebne Ponudbe</h5>
              <a
                href="#reservation"
                className="inline-block px-6 py-2.5 border border-gold text-gold font-inter text-xs tracking-wider uppercase hover:bg-gold hover:text-black-rich transition-all duration-300"
              >
                Rezerviraj Mizo
              </a>
            </div>
        ...
        >
          <div className="max-w-xl mx-auto text-center">
            <h4 className="font-playfair text-2xl text-white mb-3">Pridružite Se Naši Družini</h4>
            <p className="text-gray-400 font-inter text-sm font-light mb-6">
              Prijavite se za ekskluzivne ponudbe, kulinarične dogodke in novosti iz naše kuhinje.
            </p>
            <form className="flex gap-3 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Vnesite vaš email"
                className="flex-1 bg-black-card border border-white/10 px-4 py-3 text-white font-inter text-sm focus:border-gold focus:outline-none transition-colors"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-gold text-black-rich font-inter font-semibold text-sm tracking-wider uppercase hover:bg-gold-light transition-colors"
              >
                Prijava
              </button>
            </form>
      ...
      <div className="border-t border-white/5 py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a
              href="#"
              className="text-gray-600 font-inter text-xs hover:text-gold transition-colors"
            >
              Politika Zasebnosti
            </a>
            <a
