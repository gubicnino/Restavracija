      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Ime */}
            <div>
              <label className="block text-sm font-semibold text-gray-300 mb-2">Ime</label>
              <input
                type="text"
                value={formData.ime}
            ...
            {/* Priimek */}
            <div>
              <label className="block text-sm font-semibold text-gray-300 mb-2">Priimek</label>
              <input
                type="text"
            ...
            {!isEditing && (
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Geslo</label>
                <input
                  type="password"
            ...
            {/* Vloga */}
            <div>
              <label className="block text-sm font-semibold text-gray-300 mb-2">Vloga</label>
              <select
