...
export function Chef() {
  ...
  return (
    <section id="chef" className="relative py-32 px-6 bg-black-rich overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.div className="space-y-6 text-gray-400 font-inter font-light leading-relaxed mb-12">
              <p>
                Igor in Damjan, dva "divja" protagonista, sta srce in duša Jack & Joe. Z več kot
                desetletjem izkušenj v gostinstvu sta ustvarila edinstveno destinacijo ob Dravi,
                kjer se strast do mesa sreča s popolno izvedbo.
              </p>
              <p>
                Njuna filozofija je preprosta: izbiraj najboljše, pripravi s strastjo in postrezi z
                dušo. Vsak cut mesa, ki zapusti našo odprto kuhinjo, odraža njuno predanost
            ...
            >
              {accolades.map((item, index) => (
                <div key={index} className="text-center">
                  ...
                  <div className="font-playfair text-white text-sm mb-1">{item.title}</div>
                  <div className="text-xs text-gray-500 font-inter">{item.subtitle}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden">
              <img
                ...
                alt="Chef Marcus Wellington in the kitchen"
