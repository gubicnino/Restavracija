      ...
      <div ref={ref} className="relative max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              <p>
                Jack & Joe, restavraciji ob reki Dravi, sta svetilnik za tiste, ki so predani okusu
                mesa. Srce restavracije je odprta kuhinja, kjer se vidi, kako ekipa izvaja
                kulinarični balet. Obiskovalci imajo edinstveno priložnost, da so priča natančni
                pripravi vsake jedi in opazujejo, kako se vsaka sestavina spreminja pod spretnimi
                rokami kuharske ekipe.
              </p>
              <p>
                Za vas izbiramo le najboljše sestavine – od premium irske Black Angus govedine,
                ameriške, avstralske in slovenske govedine, ki jo sami suho zorimo »dry age«, do
                home made burger kruhkov in krompirčka. Vse v skladu z našim vodilom:{' '}
                <strong className="text-gold">"Sveže. Lokalno. Okusno."</strong>
              </p>
            </motion.div>
