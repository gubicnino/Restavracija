      ...
      error => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            errorMessage =
              'Dostop do lokacije je zavrnjen. Omogočite GPS v nastavitvah brskalnika.';
            break;
  ...
  return (
    <>
      ...
      <div className="mt-4 lg:hidden">
        <GoldButton onClick={handleOpenInMaps} className="w-full flex items-center justify-center">
