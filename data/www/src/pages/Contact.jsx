...
export default function Contact() {
  ...
  const locations = {
    limbus: {
      ...
      mapEmbed:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2743.191903012671!2d15.586562376691946!3d46.56367027111328!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x476f9de22eae1ee9%3A0xdc2494f3aa42c63c!2sJack%20%26%20Joe%20BBQ%20%26%20Pizza!5e0!3m2!1sen!2ssi!4v1765040938675!5m2!1sen!2ssi',
      hours: [
    ...
    lent: {
      ...
      mapEmbed:
        'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2743.5055605068146!2d15.637683100000004!3d46.55746690000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x476f77a54c218647%3A0x6dbc0ba740b7048b!2sJack%20%26%20Joe%20Steak%20and%20Burger%20Club!5e0!3m2!1sen!2ssi!4v1765040508090!5m2!1sen!2ssi',
      hours: [
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            <p className="text-gray-400 font-inter font-light leading-relaxed text-lg mb-6">
              Veselimo se vašega obiska! Ne glede na to, ali želite rezervirati mizo, poizvedeti o
              posebnih dogodkih ali preprosto pozdraviti našo ekipo, smo vam vedno na voljo.
            </p>
            <p className="text-gray-400 font-inter font-light leading-relaxed text-lg">
              Izberite eno od naših dveh lokacij – umirjeni{' '}
              <span className="text-gold">Limbuš</span> ob naravi ali živahni{' '}
              <span className="text-gold">Lent</span> v srcu Maribora. Kontaktirajte nas telefonsko,
              preko emaila ali nas obiščite osebno.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section ref={formRef} className="relative py-32 px-6 bg-black-card overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-gray-400 font-inter text-sm mb-2">Telefon</label>
                <input
                  type="tel"
                  className="w-full bg-black-rich border border-white/10 px-4 py-3 text-white font-inter focus:border-gold focus:outline-none transition-colors"
                  placeholder="+386 ..."
              ...
              <div>
                <label className="block text-gray-400 font-inter text-sm mb-2">Lokacija</label>
                <select className="w-full bg-black-rich border border-white/10 px-4 py-3 text-white font-inter focus:border-gold focus:outline-none transition-colors">
            ...
            <div>
              <label className="block text-gray-400 font-inter text-sm mb-2">Sporočilo</label>
              <textarea
                rows={6}
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 font-inter font-light max-w-2xl mx-auto">
              Pridružite se nam na družbenih omrežjih za ekskluzivne ponudbe, kulinarične dogodke in
