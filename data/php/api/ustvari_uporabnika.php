...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO user (ime, priimek, email, geslo, vloga) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$ime, $priimek, $email, $hashedPassword, 'upravljalec']);
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Uspešno ustvarjen uporabnik',
        'user' => [
            'id' => $userId,
            'ime' => $ime,
            'priimek' => $priimek,
